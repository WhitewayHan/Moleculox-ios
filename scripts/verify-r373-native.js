...
if(!['ios','android'].includes(platform)) throw new Error('Usage: verify-r373-native.js ios|android');
...
must(idx.includes("window.__MX_BUILD_ID__='8.7.205-r373-science-legends-"+platform+"';"),'wrong native build id');
...
must(game.includes('const APP_VERSION="v8.7.205 · R373 SCIENCE LEGENDS";'),'R373 visible version mismatch');
must(css.includes('R373 iOS NATIVE · TRUE PHYSICAL BOTTOM ANCHOR'),'R373 iOS physical-bottom CSS marker missing');
...
console.log('R373 '+platform+' native source verification PASS');
