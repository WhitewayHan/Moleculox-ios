...
if info.get('CFBundleShortVersionString') != '8.7.97':
    raise SystemExit(
        'Built IPA marketing version mismatch: '
        f'CFBundleShortVersionString={info.get("CFBundleShortVersionString")!r}, expected 8.7.97'
    )
...
print(
    f'Validated built IPA: {ipa.name}, version=8.7.97, '
